...
//        int[] levelOrder = {3,5,1,6,2,0,8,-200,-200,7,4};
...
//        if(findLeft==null && findRight==null) return null;
//
...
class BSTIterator {
    public static void main(String[] args) {
        int[] levelOrder = {7, 3, 15, -200, -200, 9, 20};
        TreeNode root = buildTreeLevelOrder(levelOrder,0);
    ...
    public void fillStack(Stack<TreeNode> stack,TreeNode root){
        while (root!=null){
            stack.push(root);
            root = root.left;
        }
